// DreamState
// Script: DreamStateUserConfig.gml

// Set to 'true' to Abort vs Warn on errors
...
// Set the max number of history items to keep at any time
#macro DREAMSTATE_DEBUG_HISTORY_MAX_SIZE 20
